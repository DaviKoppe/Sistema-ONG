      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <img src={FacebookIcon} alt="Facebook" className="w-4 h-4 brightness-0 invert" />
            </a>
            <a
              href="https://www.instagram.com/amigosdozealguem?igsh=MXBsMXEwbHM4OHg1ZQ=="
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-8 h-8 bg-primary-foreground/20 rounded-full flex items-center justify-center hover:bg-primary-foreground/30 transition-colors"
            >
              <img src={InstagramIcon} alt="Instagram" className="w-4 h-4 brightness-0 invert" />
            </a>
            <a
              href="#"
              aria-label="WhatsApp"
